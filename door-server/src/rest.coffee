...
exports.rest = () ->
  ...
  try
    ...
    console.log 'Error reading config.json from rest.coffee!'
    process.exit(1)
...
exports.run_cmd = (cmd, args, callback) ->
